...
pabot --testlevelsplit --processes 4 -v AMBIENTE:FullHD_Resolution -d Results -x output1.xml -l log1.html -r report1.html Tests
:: Check if tests failed
if %ERRORLEVEL% NEQ 0 (
    :: Rerun only the failed tests
    pabot --testlevelsplit --processes 4 -v AMBIENTE:FullHD_Resolution --rerunfailed Results/output1.xml -d Results -x output2.xml -l log2.html -r report2.html Tests
